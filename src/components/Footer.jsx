    ...
    <>
      <MainContainer>
        <InnerContainer>
          <Left>
            <div>
              <h2 style={{ textAlign: "start" }}>COSMETIFY</h2>
            </div>
            <div>
              <p style={{ padding: "5px" }}>
      ...
      <OwnerDiv>
        <div className="p-2"> Developed by Monti</div>
        <div className="d-flex gap-1  ">
          <div>
            <EmailOutlined />
           kumarmonti445@gmail.com
          </div>
          <div>
            <LinkedIn />
            https://www.linkedin.com/in/monti-kumar-8726b51b7
          </div>
          <div>
            <PhoneAndroidOutlined />
            +91-8383814080
